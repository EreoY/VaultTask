...
class _KanbanPageState extends State<KanbanPage> {
  ...
  void _showAddTask(BoardModel board, [String? col]) => showModalBottomSheet(context: context, backgroundColor: Colors.transparent, isScrollControlled: true, builder: (context) => TaskEditModal(board: board, initialStatus: col, isDark: widget.isDark));
  ...
  void _showTaskDetails(BoardModel board, TaskModel task) => showModalBottomSheet(context: context, backgroundColor: Colors.transparent, isScrollControlled: true, builder: (context) => TaskEditModal(board: board, existingTask: task, isDark: widget.isDark));
